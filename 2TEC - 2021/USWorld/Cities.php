    ...
    <body bgcolor="#CD0000">
        ...
        <div class="container">
            <div class="row" style="margin-top:15px;">
                <div class="col-lg-12">
                    <a href="index.php">
                        <img src="img/bannerUS2.jpg" class="img-fluid">
                    </a>
                </div>
            </div>
            <p>
            ...
            <div class="row"  id="newyork">
                <div class="card col-lg-12 border-0">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <a href="" data-toggle="modal" data-target="#mdlNewYork">
                                <img src="img/ny.jpg" class="img-fluid">
                            </a>
                        </div>
                        <div class="col-md-8">
                            <div class="card-body" style="padding-top: 10px;">
                                ...
                                <p class="card-text">
                                    Nova Iorque ou Nova York (em inglês: New York) é a cidade mais populosa dos Estados Unidos e o centro da Região Metropolitana de Nova Iorque, uma das áreas metropolitanas mais populosas do mundo localizada na Região Nordeste dos Estados Unidos.
                                </p>
                                <p class="card-text">
            ...
            <hr>
            <div class="row" style="margin-top:40px;" id="boston">
                <div class="card  col-lg-12 border-0">
                    <div class="row no-gutters">
                        <div class="col-md-4">
            ...
            <hr>
            <div class="row" style="margin-top:40px;" id="sanfran">
                <div class="card  col-lg-12 border-0">
                    <div class="row no-gutters">
                        <div class="col-md-4">
            ...
            <hr>
            <div class="row" style="margin-top:40px;" id="dallas">
                <div class="card  col-lg-12 border-0">
                    <div class="row no-gutters">
                        <div class="col-md-4">
            ...
            <hr>
            <div class="row" style="margin-top:40px;" id="lasvegas">
                <div class="card  col-lg-12 border-0">
                    <div class="row no-gutters">
                        <div class="col-md-4">
